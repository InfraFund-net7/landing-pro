    ...
    return (
        <>
            <Head>
                ...
                <meta property="og:image" content={`${siteUrl}/image/investors-banner.jpg`} />
                <meta property="og:image:width" content="1200" />
                <meta property="og:image:height" content="630" />

                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Investors | InfraFund - Invest in the Future of Our Planet" />
                <meta
                    name="twitter:description"
                    content="Invest in sustainable, blockchain-secured infrastructure with InfraFund."
                />
                <meta name="twitter:image" content={`${siteUrl}/image/investors-banner.jpg`} />
            </Head>

  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content={`${siteUrl}/image/builders-hero.jpg`} />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Builders | InfraFund - Fund Your NetZero Project with Tokenisation" />
        <meta
          name="twitter:description"
          content="InfraFund provides the full-stack toolkit to fund your NetZero project, from tokenisation to global distribution."
        />
        <meta name="twitter:image" content={`${siteUrl}/image/builders-hero.jpg`} />
      </Head>

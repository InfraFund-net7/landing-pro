...
export const Investfaqs = [
  {
    ...
    answer: `When you invest on InfraFund, you are purchasing a digital token that represents a real, verifiable <br/> stake in a specific green infrastructure project. Depending on the project's funding model, this token <br/> could represent:<br/><br/>
  ...
  },
  {
    ...
    answer: `Our entire platform is architected around transparency and risk mitigation, centered on our "secret sauce": <strong>the AI-Driven Digital Twin.</strong><br/><br/>
  ...
  },
  {
    ...
    answer: `Returns are generated from the real-world revenue of the underlying infrastructure project (e.g., from selling electricity to the grid). The payment process is automated and made efficient through smart contracts.<br/><br/>
  ...
  },
  {
    id: 'invest-InfraFund',
    question:
      'Why should I invest through InfraFund instead of a traditional green investment fund?',
    answer: `InfraFund offers three fundamental advantages over traditional funds:<br/><br/>

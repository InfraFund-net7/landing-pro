    ...
    <>
      ...
      >
        ...
        <div className="w-full lg:w-[749px] h-fit flex flex-col gap-4 text-sm sm:text-base font-normal text-[#D6D6D6] text-center lg:text-left">
          ...
          <p
            className="text-justify text-gray-400 md:w-[820px]"
        ...
        >
          ...
          >
            {navItems.map((section, i) => (
              <div key={i} className="text-center text-gray-400 lg:text-left">
                      ...
                      return (
                        <li key={j}>
                          <button
                            ...
                            className="hover:text-[#24FF8E] transition-colors text-left"
                          >
                            {item.name}
                          </button>
                        </li>

    ...
    return (
        <div className=' fade-in w-full h-fit flex flex-col justify-center items-center gap-16 py-24 max-lg:py-16 max-md:py-10'>
            ...
            <div className='flex flex-col text-center gap-5 px-4'>
                ...
                <h4 className='text-xl font-normal text-gray-100 max-md:text-sm'>Our &quot;secret sauce.&quot; We create a dynamic virtual model of every project, providing live performance data and predictive risk analysis to de-risk your investment.</h4>
            </div>

            <div className="w-[1260px] h-[747px] bg-[url('/svg/builder-section.svg')] bg-cover bg-center bg-no-repeat py-10 flex justify-center items-start gap-16
                    ...
                    >
                        <div className='w-full h-fit flex justify-evenly items-center'>
                            <div className='flex flex-col text-center w-fit h-fit gap-2'>
                                ...
                                <span className='text-2xl text-white font-bold max-md:text-xl'>1.21 GW</span>
                            </div>
                            <div className='flex flex-col text-center w-fit h-fit gap-2'>
                                <h4 className='text-xl text-white font-normal max-md:text-base'>Co2 Saved</h4>
                                <span className='text-2xl text-white font-bold max-md:text-xl'>850 Tons/Year</span>
                            </div>
                        </div>
                        ...
                        <div className='w-full h-fit flex justify-evenly items-center'>
                            <div className='flex flex-col text-center w-fit h-fit gap-2'>
                                <h4 className='text-xl text-white font-normal max-md:text-base'>Performance</h4>
                                <span className='text-2xl text-white font-bold max-md:text-xl'>98.7%</span>
                            </div>
                            <div className='flex flex-col text-center w-fit h-fit gap-2'>
                                <h4 className='text-xl text-white font-normal max-md:text-base'>Token Value</h4>
                                <span className='text-2xl text-white font-bold max-md:text-xl'>£1.7</span>
                            </div>
                        </div>
                    </div>

...
export function Dropdown({
    ...
    return (
        <div className={`relative ${className}`} ref={dropdownRef}>
            ...
            <div
                className={`absolute z-50 w-full mt-1 bg-slate-800 border border-slate-700 rounded-lg shadow-xl transition-all duration-300 ease-in-out origin-top ${isOpen
                ...
                <div className="py-1 max-h-60 overflow-auto">
                    {options.map((option) => (
                        <button
                            ...
                            className={`w-full px-4 py-3 text-left hover:bg-slate-700 transition-colors duration-200 ease-in-out ${selectedValue === option.value

...
export default function SurveyOnlyForm({
  ...
  const renderStep4 = () => {
    ...
    const isFormValid = Object.values(step4Fields).every(
      (val) => val.trim() !== ''
    );
        ...
        <div className="w-full h-fit flex justify-center items-center">
          <button
            ...
            onClick={() => {
              ...
              alert(
                'Thank you! We’ll notify you when available in your region.'
              );

...
export default function Waitlistmodal({ isModalOpen, setIsModalOpen }: WaitlistmodalProps) {
            ...
            <div className="text-center flex flex-col justify-start items-center w-full h-fit px-2 gap-3 sm:gap-4">
                ...
                <div className="flex flex-col justify-center items-center w-full gap-3 sm:gap-4">
                    ...
                    <div className="flex flex-col gap-2 w-full">
                        <CustomButton
                            className={`w-full h-[48px] sm:h-[52px] text-black text-sm sm:text-base ${status === "success" ? "bg-green-500 hover:bg-green-600" : ""
                                }`}
                            variant="filled"

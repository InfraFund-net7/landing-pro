...
export default function ContactUsModal({
  ...
  return createPortal(
    <>
      ...
      <div
        className="h-auto fixed top-1/2 left-1/2 z-50 bg-[#121826] rounded-2xl shadow-2xl border border-white/5 max-w-lg w-[95vw] animate-in fade-in zoom-in-95 duration-200
                -translate-x-1/2 -translate-y-1/2"
      >
        <div className="overflow-y-auto p-8 pt-12 relative">
          <button
            onClick={onClose}

...
export default function BlogContents() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            const sections = ["main-heading", "tokenization", "benefits", "case-studies", "challenges", "conclusion"]
        ...
        <div className="min-h-screen relative py-[175px] ">
            ...
            >
                ...
                <nav className="space-y-4">
                    {[
                        { id: "main-heading", label: "Green Assets and the Liquidity Challenge" },
                        { id: "tokenization", label: "What is Tokenization and How Does It Work?" },
                        { id: "benefits", label: "Key Benefits of Tokenization for Green Assets" },
                        { id: "case-studies", label: "Case Studies: From Carbon Credits to Solar Energy" },
                        ...
                        <button
                            ...
                            className={`block text-left text-sm text-black leading-snug w-full ${activeSection === item.id
                                ? "font-black"
                                : "font-medium"
                                }`}
                        >
            ...
            <main className="p-4 sm:p-6 md:p-8 lg:p-16 w-full flex flex-col lg:flex-row gap-6 relative">
                <div className="hidden lg:block w-[404px] h-fit sticky top-[130px] self-start">
                    <nav className="space-y-6">
                        <button
                            ...
                            className={`block text-left w-full  transition-colors cursor-pointer ${activeSection === "main-heading"
                        ...
                        >
                            <h2 className="text-lg font-semibold flex items-start gap-2">
                                ...
                                <span className={activeSection === "main-heading" ? "" : "ml-7"}>
                        ...
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={item.id}>
                                    <button
                                        onClick={() => scrollToSection(item.id)}
                                        className={`flex items-start gap-2 transition-colors text-left w-full cursor-pointer ${activeSection === item.id
                                            ? "text-foreground font-bold"
                                            : "text-muted-foreground hover:text-foreground"
                                            }`}
                                    >
                ...
                <article className="w-full lg:w-[835px] space-y-12">
                    {[
                        {
                            id: "main-heading", title: "Green Assets and the Liquidity Challenge", description: `Tokenization represents a transformative opportunity to unlock capital for green assets and accelerate the
                        ...
                        {
                            id: "tokenization", title: "What is Tokenization and How Does It Work?", description: `Tokenization represents a transformative opportunity to unlock capital for green assets and accelerate the
                            transition to a sustainable future. By addressing the liquidity and accessibility challenges that have
                            historically limited investment in renewable energy and nature-based solutions, tokenization can help
                            bridge the funding gap for critical climate projects. The technology offers benefits for all stakeholders:
                            developers gain access to faster, more efficient funding; investors can participate in high-quality green
                            ...
                            world for future generations.` },
                        {
                            id: "benefits", title: "Key Benefits of Tokenization for Green Assets", description: `Tokenization represents a transformative opportunity to unlock capital for green assets and accelerate the
                            transition to a sustainable future. By addressing the liquidity and accessibility challenges that have
                            historically limited investment in renewable energy and nature-based solutions, tokenization can help
                            bridge the funding gap for critical climate projects. The technology offers benefits for all stakeholders:
                            developers gain access to faster, more efficient funding; investors can participate in high-quality green
                            ...
                            world for future generations.` },
                        {
                            id: "case-studies", title: "Case Studies: From Carbon Credits to Solar Energy", description: `Tokenization represents a transformative opportunity to unlock capital for green assets and accelerate the
                            transition to a sustainable future. By addressing the liquidity and accessibility challenges that have
                            historically limited investment in renewable energy and nature-based solutions, tokenization can help
                            bridge the funding gap for critical climate projects. The technology offers benefits for all stakeholders:
                            developers gain access to faster, more efficient funding; investors can participate in high-quality green
                            ...
                            world for future generations.` },
                        {
                            id: "challenges", title: "Challenges and the Road Ahead", description: `Tokenization represents a transformative opportunity to unlock capital for green assets and accelerate the
                            transition to a sustainable future. By addressing the liquidity and accessibility challenges that have
                            historically limited investment in renewable energy and nature-based solutions, tokenization can help
                            bridge the funding gap for critical climate projects. The technology offers benefits for all stakeholders:
                            developers gain access to faster, more efficient funding; investors can participate in high-quality green
                            ...
                            world for future generations.`},
                        {
                            id: "conclusion", title: "Conclusion", description: `Tokenization represents a transformative opportunity to unlock capital for green assets and accelerate the
                            transition to a sustainable future. By addressing the liquidity and accessibility challenges that have
                            historically limited investment in renewable energy and nature-based solutions, tokenization can help
                            bridge the funding gap for critical climate projects. The technology offers benefits for all stakeholders:
                            developers gain access to faster, more efficient funding; investors can participate in high-quality green

      ...
      <article className="text-base font-normal space-y-6 max-w-[1200px]">
        <section className="space-y-5">
          ...
          <p>
            ...
            challenges requires a diversity of thought, experience, and
            perspective. As an innovation-driven SME specialising in the
            intersection of Distributed Ledger Technology (DLT), Digital Twins,
            and public-private infrastructure financing, we are committed to
            embedding equality not just within our team, but into the very
            architecture of the technologies we build.
          </p>
          <p>
            We believe that true innovation cannot exist in an echo chamber.
            This Gender Equality Plan (GEP) outlines our foundational commitment
            to fostering an inclusive, equitable, and unbiased environment as we
            scale our operations and our impact.
          </p>
        </section>

        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">
            1. Fostering an Inclusive Organizational Culture &amp; Work-Life
            Balance
          </h2>
          <p>
            As a dynamic technology startup, we have the unique opportunity to
            build an equitable culture from the ground up. We are committed to:
          </p>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">
            2. Gender Balance in Leadership &amp; Decision-Making
          </h2>
          <p>
            While currently operating as a Micro SME, our roadmap for growth is
            intentionally inclusive. We pledge to:
          </p>
          <ul className="list-disc pl-6 space-y-1">
            <li>
        ...
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">
            3. Unbiased Recruitment &amp; Career Progression
          </h2>
          <p>
            As we hire researchers, engineers, and developers to expand our
            capabilities, we are committed to removing structural barriers in
            the talent pipeline. We will achieve this by:
          </p>
          <ul className="list-disc pl-6 space-y-1">
            <li>
              Using gender-neutral language in all job descriptions and
              partnership calls.
            </li>
            <li>
              Focusing strictly on skills-based assessments and practical
              capabilities rather than traditional, easily biased networking
              channels.
            </li>
            <li>
        ...
        <section className="space-y-4">
          ...
          <p>
            ...
            ensure our technologies do not inherit historical biases,
            stereotypes, or exclusionary defaults from legacy systems, datasets,
            or workflows—and to revisit those risks as products evolve. We will
            pursue this by:
          </p>
          <ul className="list-disc pl-6 space-y-1">
            <li>

...
export default function AboutUs() {
  ...
  return (
    <div className="w-full h-fit px-[90px] flex flex-col radial-fix justify-center items-center space-y-16 py-[175px]
      ...
      <div className="w-full h-[549px] flex justify-center items-center gap-6 relative 
        ...
        <div className="w-1/2 h-full flex flex-col justify-evenly items-start text-white px-16 
          ...
          <p className="text-[17px] font-normal w-[533px] max-lg:w-full max-md:text-sm leading-relaxed">
            ...
            system. Our founder, Iman Alibeigi, drawing on his master&apos;s thesis
            and experience managing a $2B construction portfolio, saw a{" "}
            <strong>$3.5 trillion annual investment gap</strong> and a system that
            locked out the very communities it was meant to serve. With the
            support of the <strong>University of Exeter</strong>, the UK&apos;s first
            Climate Action Impact University, and the top-ranked{" "}

    ...
    >
      ...
      >
        <div className="flex flex-col gap-6 text-white max-lg:items-center">
          ...
          <h3 className="text-2xl font-normal max-xl:text-xl max-md:text-base leading-relaxed">
            At InfraFund, we leverage the power of technology to make investing
            in renewable energy projects accessible, transparent, and rewarding
            for everyone, everywhere. We are pushing the boundaries of
            traditional finance to enable you to directly invest in a greener
            future.
          </h3>
        </div>
        <Image
      ...
      >
        {description.map((item, index) => (
          ...
          >
            ...
            />
            <div className="flex flex-col gap-2 justify-center items-center text-white w-[278px]">
              <h2 className="text-2xl font-medium max-md:text-xl">
                {item.title}
              </h2>
              <p className="text-base font-normal max-md:text-sm leading-relaxed">
                {item.description}
              </p>
            </div>
          </div>
      ...
      <section className="fade-in">
        ...
        >
          ...
          >
            <h2 className="text-[100px] max-xl:text-7xl max-lg:text-5xl max-md:text-3xl">
              Our Story
            </h2>
            <p className="text-[17px] font-normal w-[533px] max-lg:w-full max-md:text-sm leading-relaxed">
              Our story begins not with a company, but with a conviction: the
              mission to reach Net Zero is being stalled by a broken financial
              system. Our founder, Iman Alibeigi, drawing on his master&apos;s
              thesis and experience managing a $2B construction portfolio, saw a{' '}
              <strong>$3.5 trillion annual investment gap</strong> and a system
              that locked out the very communities it was meant to serve. With
              the support of the <strong>University of Exeter</strong>, the
              UK&apos;s first Climate Action Impact University, and the
              top-ranked <strong>SETsquared Partnership</strong>, this
          ...
          <div className="w-1/2 flex h-full justify-center items-end max-lg:w-full">
            <div className="w-[565px] h-[377px] rounded-[50px] bg-[url('/image/our-story.jpg')] bg-cover bg-no-repeat relative max-md:w-[90%] max-md:h-[250px]">
      ...
      <section className="fade-in">
        <div className="w-full h-fit flex flex-col gap-12 justify-center items-center text-white text-center relative px-4">
          ...
          <h3 className="text-2xl font-normal w-[937px] max-lg:w-full max-md:text-base leading-relaxed">

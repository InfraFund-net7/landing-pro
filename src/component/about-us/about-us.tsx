    ...
    max-2xl:text-8xl max-xl:text-7xl max-lg:text-5xl max-md:text-3xl"
      ...
      max-w-[550px] w-full max-lg:max-w-[600px] max-md:text-sm"
              >
                ...
                thesis and experience managing a $2B construction portfolio, saw
                a <strong>$3.5 trillion annual investment gap</strong> and a
                system that locked out the very communities it was meant to
                serve. With the support of the{' '}
                <strong>University of Exeter</strong>, the UK&apos;s first
                Climate Action Impact University, and the top-ranked{' '}
                <strong>SETsquared Partnership</strong>, this conviction was
                forged into a venture: <strong>InfraFund</strong>.
              </p>
            </div>
          </div>

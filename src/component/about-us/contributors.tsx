...
export default function ContributorsSection({ contributors, linkedin }: Props) {
    return (
        <section className="w-full">
            <div className="fade-in grid gap-x-6 gap-y-6 
                    ...
                    >
                        <div className="relative w-full">
                            <Image
                                ...
                                alt={item.name}
                            />
                            <div className="absolute bottom-0 left-0 right-0 rounded-b-[30px] p-2 bg-[#191C2980] backdrop-blur-md text-[10px] w-full h-fit text-white text-center 
        opacity-0 scale-y-0 origin-bottom transition-all duration-500 ease-in-out group-hover:opacity-100 group-hover:scale-y-100">
                        ...
                        <div className="flex flex-col gap-1 justify-center items-center text-center">
                            <div className="flex justify-center items-center gap-2">
                                ...
                                <h3 className="text-base md:text-[20px] font-normal">{item.name}</h3>
                            </div>

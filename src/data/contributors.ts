...
export const contributors = [
  ...
  },
  {
    ...
    description:
      'An enterprise blockchain architect formerly at SAP, ensuring our platform is secure, scalable, and enterprise-ready.',
  },
  {
    img: AkbarJavadi,
  ...
  },
  {
    ...
    role: 'Financial Lead',
    description:
      'Financial Lead, a skilled financial modeler with advanced expertise in mathematical finance.',
  },
  {
    img: YifengTian,
    name: 'Dr. Yifeng Tian',
    ...
    role: 'R&D Lead',
    description:
      'An expert and pioneer researcher in infrastructure tokenization leading our data-driven innovation',
  },
  {
    img: NataliaIsmagilova,
    name: 'Natalia Ismagilova',
    linkedin: 'https://www.linkedin.com/in/natalia-ismagilova-587045185',
    role: 'Web3 Legal & Regulatory Adviser',
    description:
      'Web3 Legal & Regulatory Adviser and Head of Innovation at World Talent, guiding our global compliance strategy.',
  },
  {
    img: LukeLang,
    name: 'Luke Lang',
    ...
    description:
      "The co-founder of the UK's leading crowdfunding platform, Crowdcube, advising on business and growth strategy.",
  },
  {
    img: JamesCater,
    name: 'James Cater',
    ...
    description:
      'Vice Chair of the Exeter Chamber, driving key strategic partnerships within the ecosystem.',
  },
  {
    img: KambisKohansal,
  ...
  },
  {
    ...
    role: 'Marketing Lead',
    description:
      'A Global Talent in the UK specializing in accelerating NetZero startups through strategic marketing.',
  },
  {
    img: AmirrezaZareian,
  ...
  },
  {
    ...
    role: 'Engineer',
    description:
      'Blockchain Engineer with 4+ years of experience building smart contracts and decentralized applications.',
  },
  {
    img: ShervinMansouri,
    ...
    role: 'Engineer',
    description:
      'Creating the intuitive and user-friendly interfaces for our investor and developer portals',
  },
];

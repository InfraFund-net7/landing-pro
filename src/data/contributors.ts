...
export const contributors = [
    ...
    { img: LukeLang, name: "Luke Lang", linkedin: "", role: "Business Adviser at SETsquared (EIR)", description: "The co-founder of the UK's leading crowdfunding platform, Crowdcube, advising on business and growth strategy." },
    { img: JamesCater, name: "James Cater", linkedin: "", role: "Strategic Partnership Adviser", description: "Vice Chair of the Exeter Chamber, driving key strategic partnerships within the ecosystem." },
    { img: KambisKohansal, name: "Kambis Kohansal", linkedin: "", role: "Startup Adviser", description: "Head of Startup Services at the Austrian Federal Economic Chamber, providing guidance on global startup growth." },
    { img: PooriaGhadir, name: "Dr. Pooria Ghadir", linkedin: "", role: "Marketing Lead", description: "A Global Talent in the UK specializing in accelerating NetZero startups through strategic marketing." },
